...
<table class="team">
	<form:form id="saveTeam" name="saveTeam" method="post"
		...
		<tr>
			...
			<td><span style="padding-left: 12px" id="idTip">Min 3,
					max 20 All data types and either [- . Or _ ] are allowed for
					identifier.</span></td>
		</tr>
		<tr>
			<td>Location</td>
		...
		<tr>
			<td></td>
			<td><span id="voidTip">Reason must be written</span></td>
		</tr>
		<tr>
			<td>Retire Reason</td>
		...
		<tr>
			...
			<td><button id="saveButton" type="button"
					onClick="validation();">Save</button></td>
		</tr>
